...
from materforge.parsing.utils.utilities import create_step_visualization_data, handle_numeric_temperature
...
class TestUtilitiesComprehensive:
    ...
    def test_handle_numeric_temperature_numeric_success(self, sample_material):
        ...
        T = sp.Symbol('T')
        piecewise_expr = sp.Piecewise((100, T < 500), (200, True))
        result = handle_numeric_temperature(processor, sample_material, 'test_prop', piecewise_expr, 400.0)
    ...
    def test_handle_numeric_temperature_complex_expression(self, sample_material):
        ...
        result = handle_numeric_temperature(processor, sample_material, 'complex_prop', expr, 400.0)
        assert result is True
